...
public class StrictModeException extends RuntimeException {
	...
	private static final String ERROR_MESSAGE_SUFFIX = "\n\n" +
			"This should be that big of an issue, although you definitely should report it under: " + Anvil.Debug.ISSUE_TRACKER_URL;
	
	public StrictModeException(final String errorMessage) {
		super(errorMessage + "This Exception was caused, because strict mode (Anvil.Debug.strictMode) was enabled.\n" + ERROR_MESSAGE_SUFFIX);
	}
