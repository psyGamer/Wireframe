...
public enum Material {
	...
	STONE(net.minecraft.block.material.Material.STONE, ToolType.PICKAXE, 6.0f,
		  1.5f
	),
	...
	WOOD(net.minecraft.block.material.Material.WOOD,
		 ToolType.AXE, 2.0f, 3.0f
	),
	FIREPROOF_WOOD(net.minecraft.block.material.Material.NETHER_WOOD,
				   ToolType.AXE, 2.0f, 3.0f
	),
	...
	PLANT(net.minecraft.block.material.Material.PLANT,
		  null, 0.0f
	),
	REPLACEABLE_PLANT(net.minecraft.block.material.Material.REPLACEABLE_PLANT,
					  null, 0.0f
	),
	FIREPROOF_PLANT(
			net.minecraft.block.material.Material.REPLACEABLE_FIREPROOF_PLANT,
			null, 0.0f
	),
