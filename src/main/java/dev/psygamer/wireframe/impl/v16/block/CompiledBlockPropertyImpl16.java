...
public class CompiledBlockPropertyImpl16 <T extends Comparable<T>> extends Property<T> {
	...
	protected CompiledBlockPropertyImpl16(final BlockProperty<T> blockProperty) {
