...
public interface IEventBus {
	...
	/**
	 * Add a consumer listener with default {@link Event.Priority#NORMAL} and not recieving cancelled events.
	 *
	...
	/**
	 * Add a consumer listener with the specified {@link Event.Priority} and not receiving cancelled events.
	 *
	 * @param priority {@link Event.Priority} for this listener
	 * @param consumer Callback to invoke when a matching event is received
	 * @param <T>      The {@link Event} subclass to listen for
	 */
	<T extends Event> void addListener(Event.Priority priority, Consumer<T> consumer);
	
	/**
	 * Add a consumer listener with the specified {@link Event.Priority} and potentially cancelled events.
	 *
	 * @param priority         {@link Event.Priority} for this listener
	 * @param receiveCancelled Indicate if this listener should receive events that have been {@link Event.Cancellable} cancelled
	 * @param consumer         Callback to invoke when a matching event is received
	 * @param <T>              The {@link Event} subclass to listen for
	 */
	<T extends Event> void addListener(Event.Priority priority, boolean receiveCancelled, Consumer<T> consumer);
	 ...
	 * @param <T>              The {@link Event} subclass to listen for
	 */
	<T extends Event> void addListener(Event.Priority priority, boolean receiveCancelled, Class<T> eventType, Consumer<T> consumer);
	 ...
	 * @param <F>                The {@link Class} to filter the {@link GenericEvent} for
	 */
	<T extends GenericEvent<? extends F>, F> void addGenericListener(Class<F> genericClassFilter, Event.Priority priority, Consumer<T> consumer);
	 ...
	 * @param <F>                The {@link Class} to filter the {@link GenericEvent} for
	 */
	<T extends GenericEvent<? extends F>, F> void addGenericListener(Class<F> genericClassFilter, Event.Priority priority, boolean receiveCancelled, Consumer<T> consumer);
	 ...
	 * @param <F>                The {@link Class} to filter the {@link GenericEvent} for
	 */
	<T extends GenericEvent<? extends F>, F> void addGenericListener(Class<F> genericClassFilter, Event.Priority priority, boolean receiveCancelled, Class<T> eventType, Consumer<T> consumer);
	 ...
	 * @return true if the event was {@link Event.Cancellable} cancelled
	 */
