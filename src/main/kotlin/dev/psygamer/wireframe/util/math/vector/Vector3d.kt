...
open class Vector3d(val x: Double, val y: Double, val z: Double) {
	...
	operator fun plus(scalar: Int) = Vector3d(this.x + scalar, this.y + scalar, this.z + scalar)
	operator fun plus(scalar: Float) = Vector3d(this.x + scalar, this.y + scalar, this.z + scalar)
	operator fun plus(scalar: Double) = Vector3d(this.x + scalar, this.y + scalar, this.z + scalar)

	operator fun plus(other: Vector3i) = Vector3d(this.x + other.x, this.y + other.y, this.z + other.z)
	operator fun plus(other: Vector3f) = Vector3d(this.x + other.x, this.y + other.y, this.z + other.z)
	operator fun plus(other: Vector3d) = Vector3d(this.x + other.x, this.y + other.y, this.z + other.z)

	operator fun minus(scalar: Int) = Vector3d(this.x - scalar, this.y - scalar, this.z - scalar)
	operator fun minus(scalar: Float) = Vector3d(this.x - scalar, this.y - scalar, this.z - scalar)
	operator fun minus(scalar: Double) = Vector3d(this.x - scalar, this.y - scalar, this.z - scalar)

	operator fun minus(other: Vector3i) = Vector3d(this.x - other.x, this.y - other.y, this.z - other.z)
	operator fun minus(other: Vector3f) = Vector3d(this.x - other.x, this.y - other.y, this.z - other.z)
	operator fun minus(other: Vector3d) = Vector3d(this.x - other.x, this.y - other.y, this.z - other.z)

	operator fun times(scalar: Int) = Vector3d(this.x * scalar, this.y * scalar, this.z * scalar)
	operator fun times(scalar: Float) = Vector3d(this.x * scalar, this.y * scalar, this.z * scalar)
	operator fun times(scalar: Double) = Vector3d(this.x * scalar, this.y * scalar, this.z * scalar)

	operator fun times(other: Vector3i) = Vector3d(this.x * other.x, this.y * other.y, this.z * other.z)
	operator fun times(other: Vector3f) = Vector3d(this.x * other.x, this.y * other.y, this.z * other.z)
	operator fun times(other: Vector3d) = Vector3d(this.x * other.x, this.y * other.y, this.z * other.z)

	operator fun div(other: Vector3i) = Vector3d(this.x / other.x, this.y / other.y, this.z / other.z)
	operator fun div(other: Vector3f) = Vector3d(this.x / other.x, this.y / other.y, this.z / other.z)
	operator fun div(other: Vector3d) = Vector3d(this.x / other.x, this.y / other.y, this.z / other.z)

	operator fun div(scalar: Int) = Vector3d(this.x / scalar, this.y / scalar, this.z / scalar)
	operator fun div(scalar: Float) = Vector3d(this.x / scalar, this.y / scalar, this.z / scalar)
	operator fun div(scalar: Double) = Vector3d(this.x / scalar, this.y / scalar, this.z / scalar)

	infix fun cross(other: Vector3i) = Vector3d(this.x * other.y, this.y * other.x, this.z * other.z)
	infix fun cross(other: Vector3f) = Vector3d(this.x * other.y, this.y * other.x, this.z * other.z)
